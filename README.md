...
> Provenance verifier cross-checking context claims without invoking external LLM models.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/doxa/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-doxa.git
cd tp-doxa
```
...
```bash
kubectl port-forward deployment/tp-doxa 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── provenance_checker.py     # Main configuration file
```
...
---
*Generated by [doxa Studio](https://pradeeptalari14.github.io/portfolio/tools/doxa/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
